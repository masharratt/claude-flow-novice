...
capabilities: [inclusive-design-evaluation, web-accessibility-compliance, assistive-technology-compatibility, user-experience-optimization, accessibility-standards-validation]
tags: [accessibility-advocate-persona, inclusive-design, web-accessibility, assistive-technology, user-experience, accessibility-standards, product-owners]
