...
type: specialist
color: crimson
skills: [cfn-project-analysis, cfn-ruvector-codebase-index]
capabilities: [code-analysis, performance-analysis, complexity-analysis, technical-debt, metrics-analysis]
tags: [analyst, code-analysis, performance-analysis, complexity-analysis, technical-debt, metrics-analysis, analysts]
