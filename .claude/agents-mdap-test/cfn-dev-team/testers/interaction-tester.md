...
capabilities: [UI testing, accessibility testing, integration testing, e2e testing, user flow validation, WCAG compliance, component testing]
tags: [interaction-tester, testers, UI, accessibility, integration, e2e, testing, user flows, WCAG, component]
