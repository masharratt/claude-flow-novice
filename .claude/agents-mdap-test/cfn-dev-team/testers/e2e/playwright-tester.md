...
capabilities: [e2e-testing, playwright-testing, web-portal-testing, cross-browser-testing]
tags: [playwright-tester, e2e-testing, playwright-testing, web-portal-testing, cross-browser-testing, testers]
