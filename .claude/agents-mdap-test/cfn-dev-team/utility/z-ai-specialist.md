...
capabilities: [zai-platform-integration, custom-routing-config, cost-analysis, provider-switching, usage-monitoring, routing-optimization]
tags: [z-ai-specialist, zai-platform-integration, custom-routing-config, cost-analysis, provider-switching, usage-monitoring, routing-optimization, utility]
