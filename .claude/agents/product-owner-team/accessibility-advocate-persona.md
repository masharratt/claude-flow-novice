...
```bash
npx claude-flow@alpha hooks post-edit [FILE_PATH] --memory-key "accessibility/step" --structured
```

## Success Metrics
- WCAG 2.1 Level AA compliance ≥90%
- 0 critical accessibility issues
- Keyboard accessibility for 100% critical actions
- Screen reader compatibility across major technologies
