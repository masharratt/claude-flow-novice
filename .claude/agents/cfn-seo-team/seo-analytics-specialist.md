...
description: |
  MUST BE USED when analyzing SEO traffic, tracking keyword rankings, optimizing conversions, implementing A/B tests, building reporting dashboards, or calculating SEO ROI.
  Use PROACTIVELY for performance monitoring, data visualization, KPI tracking, conversion rate optimization, attribution analysis.
  Keywords - SEO analytics, traffic analysis, ranking report, conversion optimization, SEO ROI, A/B testing, reporting dashboards, KPI tracking
