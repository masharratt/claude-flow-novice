...
description: |
  MUST BE USED when conducting keyword research, creating content briefs, developing topic clusters, analyzing SERP intent, or building pillar content strategies.
  Use PROACTIVELY for content planning, keyword clustering, competitive content analysis, search intent mapping.
  Keywords - keyword research, content strategy, pillar content, topic cluster, SERP analysis, search intent, content brief, keyword clustering
