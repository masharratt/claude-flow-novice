...
# Load environment: read specific vars from .env, or fall back to the
...
if [ -f "$ENV_FILE" ]; then
    for _env_var in CFN_DB_HOST CFN_DB_PORT CFN_DB_NAME CFN_DB_USER CFN_DB_PASSWORD CFN_EXPERT_ID CFN_EXPERT_EMAIL; do
