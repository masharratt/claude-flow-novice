...
# Replacement: dist/cli/coordination-wait.js
#
...
# Bash wrapper for TypeScript coordination-wait CLI
# Provides backward compatibility with existing bash-based coordination
#
# Usage:
#   coordination-wait.sh --task-id <id> --channel <ch> [--timeout <sec>]
#
# This wrapper delegates to the TypeScript CLI tool which provides:
# - Type-safe Redis blocking operations
...
CLI_PATH="${PROJECT_ROOT}/dist/cli/coordination-wait.js"
