# VERIFY: stale-backtick

| AC-id | criterion | binding | check | pass | trigger | seeds | signal |
|---|---|---|---|---|---|---|---|
| AC-1 | Claims exists | EC-1 | grep -q "Claims" types.ts | exit 0 | http:POST /api/signup | (none) | |
...
```json
{
  ...
  "description": "AC-3 steps define the flow"
}
```
