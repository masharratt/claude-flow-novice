...
```json
{
  "slug": "wiring-clean",
  "acs": [
    { "id": "AC-1", "check": "grep -c 'createThreadManager(' src/index.ts", "kind": "wiring-guard", "pass": "count >= 1", "trigger": "fn:check-verifiable-static", "seeds": "(none)", "signal": "", "maps_to": ["FR-20"] }
  ],
