...
## Context
You are working on subtask "test-final-validate" of the larger task "test-final".

## Your Mission
Validate fixes and run TypeScript compilation

## Tool Budget Optimization
You have **10 tool uses** available. Use them efficiently:
...
## Redis Context
- Store results in: `test-final:test-final-validate:results`
- Use confidence scoring based on deliverable completion
- Signal completion via Redis LPUSH to `test-final:test-final-validate:done`
