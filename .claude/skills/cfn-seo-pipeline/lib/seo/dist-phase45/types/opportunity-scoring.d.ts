 ...
 */
export type ScoringDimension = 'search_volume' | 'traffic_potential' | 'difficulty' | 'relevance' | 'implementation_effort' | 'competitive_advantage' | 'time_to_impact' | 'freshness' | 'authority_gain';
/**
...
//# sourceMappingURL=opportunity-scoring.d.ts.map