...
RESULTS_FILE=".artifacts/benchmarks/benchmark-create-latency.txt"
...
echo "Container Create Latency Benchmark"
echo "==================================="
...

{
    ...
    # Calculate expected proxy overhead (10-15ms is typical)
    proxy_overhead=12
