...
',
  ...
  console.log('Usage:');
  console.log(
    '  claude-flow-novice ruv-swarm <command> [options]\
',
  );
...
',
  ...
  console.log('  claude-flow-novice ruv-swarm init --topology mesh --max-agents 8');
  console.log('  claude-flow-novice ruv-swarm spawn researcher --name \"AI Researcher\"');
  console.log('  claude-flow-novice ruv-swarm orchestrate \"Build a REST API\"');
  console.log('  claude-flow-novice ruv-swarm neural train --iterations 20');
  console.log('  claude-flow-novice ruv-swarm benchmark --type swarm');
}
...
async function handleSpawn(ctx: CommandContext) {
  if (ctx.args.length === 0) {
    ...
    console.log('Usage: claude-flow-novice ruv-swarm spawn <type> [--name <name>]');
...
async function handleOrchestrate(ctx: CommandContext) {
  if (ctx.args.length === 0) {
    ...
    console.log('Usage: claude-flow-novice ruv-swarm orchestrate \"<task description>\" [options]');
    return;
  }
