...
# Main commands
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'start' -d 'Start the Claude-Flow orchestration system'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'agent' -d 'Manage Claude-Flow agents'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'task' -d 'Manage tasks'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'memory' -d 'Manage agent memory'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'config' -d 'Manage Claude-Flow configuration'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'status' -d 'Show Claude-Flow system status'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'monitor' -d 'Start live monitoring dashboard'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'session' -d 'Manage Claude-Flow sessions'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'workflow' -d 'Execute and manage workflows'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'repl' -d 'Start interactive REPL mode'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'version' -d 'Show detailed version information'
complete -f -c claude-flow-novice -n '__fish_claude_flow_needs_command' -a 'completion' -d 'Generate shell completion scripts'

# Global options
complete -c claude-flow-novice -s h -l help -d 'Show help information'
complete -c claude-flow-novice -s v -l verbose -d 'Enable verbose logging'
complete -c claude-flow-novice -s q -l quiet -d 'Suppress non-essential output'
complete -c claude-flow-novice -s c -l config -r -d 'Path to configuration file'
complete -c claude-flow-novice -l log-level -r -a 'debug info warn error' -d 'Set log level'
complete -c claude-flow-novice -l no-color -d 'Disable colored output'
complete -c claude-flow-novice -l json -d 'Output in JSON format'
complete -c claude-flow-novice -l profile -r -d 'Use named configuration profile'

# Agent subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command agent' -a 'spawn' -d 'Spawn a new agent'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command agent' -a 'list' -d 'List all agents'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command agent' -a 'terminate' -d 'Terminate an agent'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command agent' -a 'info' -d 'Get agent information'

# Task subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command task' -a 'create' -d 'Create a new task'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command task' -a 'list' -d 'List all tasks'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command task' -a 'status' -d 'Get task status'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command task' -a 'cancel' -d 'Cancel a task'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command task' -a 'workflow' -d 'Execute workflow from file'

# Memory subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command memory' -a 'query' -d 'Query memory entries'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command memory' -a 'export' -d 'Export memory to file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command memory' -a 'import' -d 'Import memory from file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command memory' -a 'stats' -d 'Show memory statistics'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command memory' -a 'cleanup' -d 'Clean up old entries'

# Config subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command config' -a 'show' -d 'Show current configuration'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command config' -a 'get' -d 'Get specific config value'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command config' -a 'set' -d 'Set config value'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command config' -a 'init' -d 'Initialize config file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command config' -a 'validate' -d 'Validate config file'

# Session subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'list' -d 'List all saved sessions'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'save' -d 'Save current session state'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'restore' -d 'Restore a saved session'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'delete' -d 'Delete a saved session'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'export' -d 'Export session to file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'import' -d 'Import session from file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'info' -d 'Show detailed session information'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command session' -a 'clean' -d 'Clean up old sessions'

# Workflow subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command workflow' -a 'run' -d 'Execute a workflow from file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command workflow' -a 'validate' -d 'Validate a workflow file'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command workflow' -a 'list' -d 'List running workflows'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command workflow' -a 'status' -d 'Show workflow execution status'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command workflow' -a 'stop' -d 'Stop a running workflow'
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command workflow' -a 'template' -d 'Generate workflow templates'

# Completion subcommands
complete -f -c claude-flow-novice -n '__fish_claude_flow_using_command completion' -a 'bash zsh fish'`;
  }
