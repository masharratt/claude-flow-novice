...
describe('Agents API Security', () => {
  ...
  describe('Rate Limiting', () => {
    ...
    it('should block 101st request with 429 status', async () => {
      const res = await request(app).get('/api/agents/hybrid');
  ...
  describe('SQL-Based Filtering', () => {
    it('should filter by status using SQL', async () => {
    ...
    it('should filter by provider using SQL', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
        .query({ provider: 'zai' });
    ...
    it('should filter by confidence range using SQL', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
    ...
    it('should combine multiple filters using SQL', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
        .query({
          status: 'completed',
  ...
  describe('SQL Injection Prevention', () => {
    it('should reject SQL injection in status parameter', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
    ...
    it('should reject SQL injection in provider parameter', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
    ...
    it('should handle malicious confidence_min values', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
    ...
    it('should handle malicious confidence_max values', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
  ...
  describe('Error Handling', () => {
    it('should return 400 for invalid confidence range', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
    ...
    it('should return 400 for invalid provider enum', async () => {
      const res = await request(app)
        .get('/api/agents/hybrid')
