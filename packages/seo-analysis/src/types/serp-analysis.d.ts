 ...
 */
export declare enum SERPFeatureType {
 ...
 */
export declare enum FeaturedSnippetType {
    PARAGRAPH = "paragraph",
    LIST = "list",
    TABLE = "table",
    VIDEO = "video"
 ...
 */
export declare enum FreshnessSignal {
 ...
 */
export declare enum SERPAnalysisErrorCode {
 ...
 * SERP analysis error
 */
export declare class SERPAnalysisError extends Error {
    code: SERPAnalysisErrorCode;
    details?: Record<string, unknown> | undefined;
    constructor(code: SERPAnalysisErrorCode, message: string, details?: Record<string, unknown> | undefined);
}
/**
 ...
 */
export declare function isSuccessfulGoogleSearch(response: GoogleSearchResponse): response is Required<GoogleSearchResponse> & {
    items: GoogleSearchItem[];
};
/**
 * Type guard for successful DataForSEO response
 */
export declare function isSuccessfulDataForSEOSearch(response: DataForSEOResponse): response is DataForSEOResponse & {
    tasks: Array<{
        status_code: number;
        result: Array<{
            items: DataForSEOItem[];
 ...
 */
export type FirecrawlErrorCode = 'API_KEY_MISSING' | 'INVALID_CONFIG' | 'INVALID_URL' | 'SCRAPE_FAILED' | 'API_REQUEST_FAILED' | 'RATE_LIMIT_EXCEEDED' | 'MAX_RETRIES_EXCEEDED' | 'TIMEOUT';
/**
...
//# sourceMappingURL=serp-analysis.d.ts.map