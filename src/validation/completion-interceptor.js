...
export class CompletionInterceptor {
  ...
  async updateInterceptionMetrics(interceptionTime, successful) {
    ...
    const newAvgTime =
      (this.performanceMetrics.averageInterceptionTime *
        (this.performanceMetrics.totalInterceptions - 1) +
        interceptionTime) /
      this.performanceMetrics.totalInterceptions;

    this.performanceMetrics.averageInterceptionTime = newAvgTime;
    this.interceptionRate =
      this.performanceMetrics.successfulInterceptions / this.performanceMetrics.totalInterceptions;
