...
class ByzantineSecurityManager extends EventEmitter {
    ...
    async auditSecurityEvents() {
        ...
        const auditResults = {
            ...
            consensusSuccessRate: recentEvents.filter(e => e.consensusAchieved).length / recentEvents.length,
            averageConsensusDuration: recentEvents.reduce((sum, e) => sum + e.consensusDuration, 0) / recentEvents.length,
