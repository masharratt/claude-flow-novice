...
export function setupCommands(cli: CLI): void {
  ...
  cli.command({
    ...
    action: async (ctx: CommandContext) => {
      try {
        ...
        console.log(
          "  ✓ Created .mcp.json with claude-flow-novice and ruv-swarm servers",
        );
        ...
        const hooksConfig = {
          hooks: {
            pre_task: {
              enabled: true,
              command:
                'npx claude-flow-novice@latest hooks pre-task --description "$TASK_DESCRIPTION"',
              description: "Pre-task coordination hook",
            },
            post_edit: {
              enabled: true,
              command:
                'npx claude-flow-novice@latest hooks post-edit --file "$FILE_PATH" --memory-key "swarm/$AGENT_ID/$STEP"',
              description: "Post-edit memory storage hook",
            },
            post_task: {
              enabled: true,
              command:
                'npx claude-flow-novice@latest hooks post-task --task-id "$TASK_ID"',
        ...
        console.log(
          "  ✓ Created .claude/hooks.json with automated coordination",
        );
        ...
        console.log(
          `  ✓ Created ${basicAgents.length} essential agent definitions`,
        );
        ...
        console.log(
          "2. Run 'npx claude-flow-novice start' to begin the orchestration system",
        );
        console.log(
      ...
      try {
        ...
        switch (subcommand) {
          ...
          case "health":
            ...
            console.log(
              `  - claude-flow-novice agent ${subcommand} ${ctx.args.slice(1).join(" ")}`,
            );
            console.log(
          ...
          default: {
            ...
            console.log("");
            console.log(
              "For detailed help, use: claude-flow-novice agent <command> --help",
            );
            break;
          }
        }
  ...
  try {
    ...
    const enhancedStatusAction = async (ctx: CommandContext) => {
      ...
      console.log(
        "For full enhanced functionality, use: claude-flow-novice status [options]",
      );
      console.log(
      ...
      switch (subcommand) {
        case "start": {
          ...
          try {
            ...
            if (!health.healthy) {
              warning(
                "Orchestrator is not running. Start it first with 'claude-flow-novice start'",
              );
              return;
            }
            ...
            console.log(
              `📚 Use 'claude-flow-novice mcp tools' to see all available tools`,
            );
          } catch (err) {
        ...
        case "stop": {
          try {
            ...
            if (!health.healthy) {
              ...
              warning(
                "MCP server runs as part of the orchestrator. Use 'claude-flow-novice stop' to stop the entire system",
              );
            }
          } catch (err) {
            error(`Failed to check MCP server: ${(err as Error).message}`);
        ...
        case "restart": {
          try {
            warning(
              "MCP server runs as part of the orchestrator. Use 'claude-flow-novice stop' then 'claude-flow-novice start' to restart the entire system",
            );
          } catch (err) {
...
Now, please proceed with the task: ${task}`;
            ...
            if (ctx.flags.dryRun || ctx.flags["dry-run"] || ctx.flags.d) {
              ...
              console.log(`\nEnhanced Features:`);
              console.log(
                `  - Memory Bank enabled via: npx claude-flow-novice memory commands`,
              );
              console.log(
        ...
        default: {
          ...
          console.log(
            '  claude-flow-novice claude spawn "fix bug in payment system" --no-permissions',
          );
          console.log(
            "  claude-flow-novice claude batch workflow.json --dry-run",
          );
          break;
        }
      }
  ...
  try {
    const enhancedMonitorAction = async (ctx: CommandContext) => {
      ...
      console.log(
        "For full enhanced functionality, use: claude-flow-novice monitor [options]",
      );
      console.log(
  ...
  try {
    const enhancedSessionAction = async (ctx: CommandContext) => {
      ...
      console.log(
        "For full enhanced functionality, use: claude-flow-novice session <command> [options]",
      );
      console.log();
      ...
      if (subcommand) {
        console.log();
        console.log(
          `For detailed help on '${subcommand}', use: claude-flow-novice session ${subcommand} --help`,
        );
      }
    };
  ...
  try {
    const enhancedStartAction = async (ctx: CommandContext) => {
      ...
      console.log();
      console.log(
        "For full enhanced functionality, use: claude-flow-novice start [options]",
      );
      console.log(
  ...
  cli.command({
    ...
    action: (ctx: CommandContext) => {
      ...
      if (command === "claude") {
        ...
        console.log(
          `  ${blue("claude-flow-novice claude spawn")} "implement user authentication" --research --parallel`,
        );
        console.log(
          `  ${blue("claude-flow-novice claude spawn")} "fix payment bug" --tools "View,Edit,Bash" --no-permissions`,
        );
        console.log(
          `  ${blue("claude-flow-novice claude batch")} workflow.json --dry-run`,
        );
        console.log();
        console.log(
        ...
        console.log(
          "  claude-flow-novice swarm-ui <objective> [options]  # Uses blessed UI (avoids TTY issues)",
        );
        console.log();
        ...
        console.log(
          `  ${blue("claude-flow-novice swarm-ui")} "Build a REST API"  # Avoids TTY issues`,
        );
        console.log(
          `  ${blue("claude-flow-novice swarm")} "Research cloud architecture" --strategy research --research`,
        );
        console.log(
          `  ${blue("claude-flow-novice swarm")} "Migrate app to microservices" --coordinator --review --ui`,
        );
        console.log();
        ...
        console.log(
          `  - ${blue("claude-flow-novice swarm-ui")} <objective>  # Recommended`,
        );
        ...
        console.log(bold("Examples:"));
        console.log(
          `  ${blue("claude-flow-novice sparc modes")}                              # List all modes`,
        );
        console.log(
          `  ${blue("claude-flow-novice sparc run code")} "implement user auth"      # Run specific mode`,
        );
        console.log(
          `  ${blue("claude-flow-novice sparc tdd")} "payment processing system"    # Full TDD workflow`,
        );
        console.log(
          `  ${blue("claude-flow-novice sparc workflow")} project-workflow.json     # Custom workflow`,
        );
        console.log();
        console.log(
        ...
        console.log(bold("Examples:"));
        console.log(
          `  ${blue("claude-flow-novice start")}                    # Interactive mode`,
        );
        console.log(
          `  ${blue("claude-flow-novice start --daemon")}           # Background daemon`,
        );
        console.log(
          `  ${blue("claude-flow-novice start --ui")}               # Process management UI`,
        );
        console.log(
          `  ${blue("claude-flow-novice start --health-check")}     # With pre-flight checks`,
        );
        ...
        console.log(bold("Examples:"));
        console.log(
          `  ${blue("claude-flow-novice status")}                   # Basic status`,
        );
        console.log(
          `  ${blue("claude-flow-novice status --watch")}           # Live updates`,
        );
        console.log(
          `  ${blue("claude-flow-novice status --detailed")}        # Comprehensive info`,
        );
        console.log(
          `  ${blue("claude-flow-novice status --component mcp")}   # Specific component`,
        );
        ...
        console.log(
          "  --log-level <level>      Log level filter (error, warn, info, debug)",
        );
        console.log("  --no-graphs              Disable ASCII graphs");
        console.log();
        console.log(bold("Examples:"));
        console.log(
          `  ${blue("claude-flow-novice monitor")}                  # Basic monitoring`,
        );
        console.log(
          `  ${blue("claude-flow-novice monitor --alerts")}         # With alerting`,
        );
        console.log(
          `  ${blue("claude-flow-novice monitor --focus mcp")}      # Component focus`,
        );
        console.log(
          `  ${blue("claude-flow-novice monitor --export data.json")} # Data export`,
        );
        ...
        console.log(bold("Examples:"));
        console.log(
          `  ${blue("claude-flow-novice session list")}             # List sessions`,
        );
        console.log(
          `  ${blue("claude-flow-novice session save mywork")}      # Save session`,
        );
        console.log(
          `  ${blue("claude-flow-novice session restore abc123")}   # Restore session`,
        );
        console.log(
          `  ${blue("claude-flow-novice session validate --fix")}   # Validate and fix`,
        );
      } else {
  ...
  console.log();
  console.log(
    "For detailed help on enhanced commands: claude-flow-novice help <command>",
  );
...
function createFullClaudeMd(): string {
  ...
  try {
    ...
    console.warn(
      "Warning: Enhanced CLAUDE.md template not found, using minimal version",
    );
