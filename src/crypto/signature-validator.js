...
class CryptographicValidator {
     ...
     */
    async validateSignature({ message, signature, publicKey, algorithm = "RSA-PSS", hashAlgorithm = "sha256" }) {
        ...
        try {
            ...
            const isValid = crypto.verify(
                ...
                {
                    key: publicKey,
                    padding: algorithm === "RSA-PSS" ? crypto.constants.RSA_PKCS1_PSS_PADDING : crypto.constants.RSA_PKCS1_PADDING,
