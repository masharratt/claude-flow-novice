  ...
  private initializeDefaultTemplates(): void {
    ...
    this.templates.set('researcher', {
      ...
      environment: {
        ...
        apiEndpoints: {},
        credentials: {},
        availableTools: ['WebSearch', 'WebFetch', 'Read', 'Write', 'Grep', 'Glob'],
        toolConfigs: {},
      },
    ...
    this.templates.set('coder', {
      ...
      environment: {
        ...
        apiEndpoints: {},
        credentials: {},
        availableTools: ['Read', 'Write', 'Edit', 'MultiEdit', 'Bash', 'Glob', 'Grep'],
        toolConfigs: {},
      },
  ...
  private initializeSpecializedTemplates(): void {
    ...
    this.templates.set('analyst', {
      ...
      environment: {
        ...
        apiEndpoints: {},
        credentials: {},
        availableTools: ['Read', 'Write', 'Edit', 'Bash', 'Glob', 'Grep', 'NotebookEdit'],
        toolConfigs: {},
      },
    ...
    this.templates.set('requirements-engineer', {
      ...
      environment: {
        ...
        apiEndpoints: {},
        credentials: {},
        availableTools: ['Read', 'Write', 'Edit', 'WebSearch', 'WebFetch'],
        toolConfigs: {},
      },
    ...
    this.templates.set('task-planner', {
      ...
      environment: {
        ...
        apiEndpoints: {},
        credentials: {},
        availableTools: ['Read', 'Write', 'Edit', 'TodoWrite', 'Task'],
        toolConfigs: {},
      },
    ...
    this.templates.set('reviewer', {
      ...
      environment: {
        ...
        apiEndpoints: {},
        credentials: {},
        availableTools: ['Read', 'Edit', 'Glob', 'Grep'],
        toolConfigs: {},
      },
