...
**Location**: `tests/hello-world-docker/`
...
node tests/hello-world-docker/layer1/layer1-docker-mesh-coordination.cjs
node tests/hello-world-docker/layer2/layer2-docker-review-coordination.cjs
node tests/hello-world-docker/layer3/layer3-docker-error-retry.cjs
...
|------|------------|-----------------|--------|
| 2025-11-05 | Docker Hello World | `test-results/hello-world-docker/` | ✅ PASSED |
