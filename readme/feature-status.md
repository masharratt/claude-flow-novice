...
**Last Updated:** 2026-08-19 (check-size.sh byte caps adopted by full megaplan tier profiles + lite at every level join; --unattended flag) | **Version:** 2.21.0 | **Status:** Production
