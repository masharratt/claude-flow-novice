...
**Last Updated:** 2026-08-21 (guide v2.28.0: plan routing by depth instead of megaplan-required triggers, manifest/session tracks; test-flag, caveman-controls, and pipeline detail extracted to references with the carve-out guard test following the move) | **Version:** 2.21.0 | **Status:** Production
