...
async function testSingleAgentWithPAT() {
  console.log("Configuring Trigger.dev SDK with Personal Access Token...");

  // Configure SDK with access token
  configure({
    accessToken: process.env.TRIGGER_ACCESS_TOKEN || "tr_pat_8zooz91565o8k2b2qqtk2nr2tcckfva1hexaps72",
...
testSingleAgentWithPAT().catch(console.error);
