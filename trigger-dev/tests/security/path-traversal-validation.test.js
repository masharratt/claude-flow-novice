 ...
 */
export function getDeliverablePath(taskId, filename) {
...
describe('Security: Path Traversal Prevention', () => {
    describe('validateTaskId', () => {
        ...
        it('should reject taskId with path traversal attempt (..)', () => {
            expect(() => validateTaskId('../../etc/passwd')).toThrow('Invalid taskId format: contains unsafe characters');
            expect(() => validateTaskId('..')).toThrow('Invalid taskId format: contains unsafe characters');
            expect(() => validateTaskId('../../../root')).toThrow('Invalid taskId format: contains unsafe characters');
        });
        ...
        it('should reject taskId with backslash (Windows directory separator)', () => {
            ...
            expect(() => validateTaskId('..\\..\\windows\\system32')).toThrow('Invalid taskId format: contains unsafe characters');
        });
        ...
        it('should reject taskId with special shell characters', () => {
            ...
            expect(() => validateTaskId('task | cat /etc/passwd')).toThrow('Invalid taskId format: contains unsafe characters');
        });
        ...
        it('should reject non-string taskId', () => {
            expect(() => validateTaskId(null)).toThrow('Invalid taskId: expected non-empty string');
            expect(() => validateTaskId(undefined)).toThrow('Invalid taskId: expected non-empty string');
            expect(() => validateTaskId(123)).toThrow('Invalid taskId: expected non-empty string');
        });
    ...
    describe('getDeliverablePath', () => {
        ...
        it('should reject malicious taskId in path construction', () => {
            expect(() => getDeliverablePath('../../etc/passwd', 'exploit.txt')).toThrow('Invalid taskId format');
        });
...
//# sourceMappingURL=path-traversal-validation.test.js.map