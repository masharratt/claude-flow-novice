...
describe('CFN Loop Workflow Error Handling', () => {
    ...
    describe('Event Error Handling', () => {
        it('should handle event dispatch failures gracefully', async () => {
            ...
            const mockSendEvent = vi.fn().mockRejectedValue(new Error('Event bus unavailable'));
        ...
        it('should handle invalid event payloads gracefully', async () => {
            ...
            const mockSendEvent = vi.fn().mockRejectedValue(new Error('Invalid payload: missing required field "taskId"'));
            const spawnAgent = async (payload) => {
                try {
    ...
    describe('Recovery Strategies', () => {
        ...
        it('should provide fallback values on non-critical errors', async () => {
            ...
            const mockParseOutput = vi.fn().mockImplementation((output) => {
...
//# sourceMappingURL=cfn-loop-error-handling.test.js.map