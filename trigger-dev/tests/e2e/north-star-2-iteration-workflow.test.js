...
async function pollForWorkflowCompletion(eventId, maxAttempts = 600, // 600 attempts × 1s = 10 minutes max
pollIntervalMs = 1000) {
    const startTime = Date.now();
    let attempts = 0;
...
//# sourceMappingURL=north-star-2-iteration-workflow.test.js.map